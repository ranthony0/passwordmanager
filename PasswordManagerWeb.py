...
class PasswordManagerWeb:
    ...
    def print_account_lists():
        return render_template("print_account_lists.html", account_lists=PasswordManagerWeb.__account_lists)
    ...
    def run(self):
        PasswordManagerWeb.__account_lists, PasswordManagerWeb.__all_accounts = PasswordManagerWeb.read_account_lists()
